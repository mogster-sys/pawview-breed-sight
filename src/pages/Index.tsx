      ...
      <div className="max-w-5xl mx-auto py-8 px-2">
        <header className="my-10 text-center">
          ...
          <div className="text-lg text-gray-800 max-w-2xl mx-auto mb-7">
            Select your dog's breed; to simulate how color and visual fields look different to them with retinal configuration (Area Centralis or Visual Streak), activate the live camera filter, and see exactly how different dogs process visual information. Educational, fun, and science-backed!
          </div>
        </header>
